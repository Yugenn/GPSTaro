                ...
                <div class="h-full flex flex-auto bg-purple-900 text-white bg-no-repeat bg-cover relative bg-image">
                    <div class="w-4/5 flex flex-auto flex-col md:flex-row items-center justify-center p-10 xl:p-32 overflow-hidden">
                        ...
                        <div class="w-4/5 z-10">
                            <h2 class="text-xl xl:text-3xl italic mb-6">GP.S太郎</h2>
                            <div class="text-5xl sm:text-6xl xl:text-8xl font-bold leading-tight mb-6">車の維持費<br>高くない?
                            </div>
                            <div class="sm:text-sm xl:text-md text-gray-200 font-normal">GP.S太郎は車に広告を掲載して収入を得たい人と、広告を掲載したい企業をマッチングするサービスです。</div>
                        </div>
